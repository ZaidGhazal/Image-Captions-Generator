"""This is a neural network architecture for an image captioning model, implemented using PyTorch's nn module."""
import torch
...
class ImageEncoder(nn.Module):
    ...
    def forward(self, images):
        ...
        features : torch.Tensor
            The lower-dimensional feature representation of the images.
        """
...
def weights_init(m):
    """The Function to initialize weights of the model with xavier initialization.

    Parameters
    ----------
    m : torch.nn.Module
        The model to initialize the weights of.
...
class TextDecoder(nn.Module):
    ...
    def __init__(
        self, embed_size: int, hidden_size: int, vocab_size: int, num_layers: int = 1
    ):
        """
        ...
        embed_size : int
            The size of the embedding layer.
        hidden_size : int
            The size of the hidden state of the LSTM layer.
        vocab_size : int
            The size of the vocabulary.
        num_layers : int
            The number of layers in the LSTM layer.
        """
    ...
    def forward(self, features, captions):
        ...
        outputs, (self.hidden_state, self.cell_state) = self.lstm(
            vals, (self.hidden_state, self.cell_state)
        )
    ...
    def sample(self, inputs, hidden_size, states=None, max_len=20):
        """
        Sample a caption for the given image features.
